...
function _Report_GetFilters() {
    ...
    console.log("Report_GetFilters()", report.getFilters());
...
function _Events_DataSelected() {
    ...
    report.on("dataSelected", function (event) {
        ...
        if (data['dataPoints']['0']['identity']['0']['column'] === "Manufacturer") {
            value1 = data['dataPoints']['0']['identity']['0']['equals'];
        }

        if (data['dataPoints']['0']['identity']['0']['column'] === "Product") {
            value2 = data['dataPoints']['0']['identity']['0']['equals'];
        }
    });
        ...
        .then(function (page) {
            ...
            page.createVisual('clusteredColumnChart')
                .then(function (response) {
                    ...
                    const totalUnitsMeasure = {
                        measure: 'Total Units',
                        table: 'SalesFact',
                        schema: 'http://powerbi.com/product/schema#measure'
                    };
                    const totalVanArsdelUnitsMeasure = {
                        measure: 'Total VanArsdel Units',
                        table: 'SalesFact',
                        schema: 'http://powerbi.com/product/schema#measure'
                    };
                    ...
                    }, {schema: 'http://powerbi.com/product/schema#property', value: 8});
                    visual.setProperty({
                        objectName: "title",
                        propertyName: "fontColor"
                    }, {schema: 'http://powerbi.com/product/schema#property', value: '#000000'});
    ...
    SetAuthoringPageActive(report)
        .then(function (page) {
            page.getVisuals().then(function (visuals) {
                ...
                }, {schema: 'http://powerbi.com/product/schema#property', value: 'BottomCenter'})
                    .then(function () {
